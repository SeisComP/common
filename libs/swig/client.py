...
class Protocol(object):
    ...
    def recv(self, *args):
        r"""
        recv(Protocol self, Packet p) -> Seiscomp::Client::Result
        recv(Protocol self, Seiscomp::Client::Result * result=None) -> Packet
        """
        return _client.Protocol_recv(self, *args)
...
class Connection(seiscomp.core.BaseObject):
    ...
    def recv(self, *args):
        r"""
        recv(Connection self, Seiscomp::Client::Packet ** packet=None, Seiscomp::Client::Result * status=None) -> Message
        recv(Connection self, Seiscomp::Client::PacketPtr & packet, Seiscomp::Client::Result * status=None) -> Message
        """
        return _client.Connection_recv(self, *args)
