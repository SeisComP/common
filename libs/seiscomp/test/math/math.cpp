...
BOOST_AUTO_TEST_CASE(Double2Frac) {
	...
	std::vector<std::pair<double, double> > data = {
		...
		{ 10000000.01, sloppy },
		{ 10000000.001, sloppy },
		{ 10000000.0001, sloppy },
		{ 10000000.00001, sloppy },
		{ 10.9, exact },
		{ 100.9, exact },
		{ 1000.9, exact },
		{ 10000.9, exact },
		...
		{ 10000000.09, sloppy },
		{ 10000000.009, sloppy },
		{ 10000000.0009, sloppy },
		{ 10000000.00009, sloppy },
		{ 9.9, exact },
		{ 99.9, exact },
		{ 999.9, exact },
		{ 99999.1, exact },
	...
	for ( auto sign : {1, -1} ) {
		for ( const auto &d : data ) {
			const auto &abs_value = d.first;
			const auto &requiredPrecision = d.second;
