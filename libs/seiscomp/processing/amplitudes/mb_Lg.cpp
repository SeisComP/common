...
#define SEISCOMP_COMPONENT Amplitudemb_Lg

#include <seiscomp/logging/log.h>
#include <seiscomp/processing/regions.h>
#include <seiscomp/processing/amplitudes/mb_Lg.h>
...
REGISTER_AMPLITUDEPROCESSOR(AmplitudeProcessor_mb_Lg2h, "mb_Lg");
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
AmplitudeProcessor_mb_Lg::AmplitudeProcessor_mb_Lg()
: AbstractAmplitudeProcessor_ML("mb_Lg") {}
// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
AmplitudeProcessor_mb_Lg2h::AmplitudeProcessor_mb_Lg2h()
: AmplitudeProcessor("mb_Lg") {
	setDefaultConfiguration();
	AmplitudeProcessor_mb_Lg2h::reset();
	...
	_ampE.setPublishFunction(bind(&AmplitudeProcessor_mb_Lg2h::newAmplitude, this, placeholders::_1, placeholders::_2));
	_ampN.setPublishFunction(bind(&AmplitudeProcessor_mb_Lg2h::newAmplitude, this, placeholders::_1, placeholders::_2));
}
// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
void AmplitudeProcessor_mb_Lg2h::setDefaultConfiguration() {
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
int AmplitudeProcessor_mb_Lg2h::capabilities() const {
...
AmplitudeProcessor_mb_Lg2h::capabilityParameters(Capability cap) const {
	if ( cap == Combiner ) {
		IDList params;
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
bool AmplitudeProcessor_mb_Lg2h::setParameter(Capability cap, const std::string &value) {
	if ( cap == Combiner ) {
		if ( value == "Min" ) {
			_combiner = TakeMin;
			return true;
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
std::string AmplitudeProcessor_mb_Lg2h::parameter(Capability cap) const {
	if ( cap == Combiner ) {
		switch ( _combiner ) {
			case TakeMin:
				return "Min";
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
void AmplitudeProcessor_mb_Lg2h::reset() {
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
bool AmplitudeProcessor_mb_Lg2h::setup(const Settings &settings) {
	setDefaultConfiguration();
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
void AmplitudeProcessor_mb_Lg2h::setTrigger(const Core::Time &trigger) {
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
void AmplitudeProcessor_mb_Lg2h::setEnvironment(const DataModel::Origin *hypocenter,
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
void AmplitudeProcessor_mb_Lg2h::computeTimeWindow() {
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
bool AmplitudeProcessor_mb_Lg2h::computeAmplitude(
		const DoubleArray &,
		size_t, size_t,
		size_t, size_t,
		double,
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
void AmplitudeProcessor_mb_Lg2h::close() const {}
// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
bool AmplitudeProcessor_mb_Lg2h::feed(const Record *record) {
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
void AmplitudeProcessor_mb_Lg2h::newAmplitude(const AmplitudeProcessor *proc,
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
const AmplitudeProcessor *AmplitudeProcessor_mb_Lg2h::componentProcessor(Component comp) const {
	switch ( comp ) {
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
const DoubleArray *AmplitudeProcessor_mb_Lg2h::processedData(Component comp) const {
	switch ( comp ) {
		case FirstHorizontalComponent:
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
void AmplitudeProcessor_mb_Lg2h::reprocess(OPT(double) searchBegin, OPT(double) searchEnd) {
