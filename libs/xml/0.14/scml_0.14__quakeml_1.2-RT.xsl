 ...
 *
 *
 * SCML 0.14 to QuakeML 1.2 RT stylesheet converter
 ...
 * ================
 *
 * This stylesheet converts a SCML to a QuakeML-RT document. It may be
 * invoked, e.g., using xalan or xsltproc:
 *
 *   xalan -in scml.xml -xsl scml_0.14__quakeml_1.2-RT.xsl -out quakeml.xml
 *   xsltproc -o quakeml.xml scml_0.14__quakeml_1.2-RT.xsl scml.xml
 *
 * You can also modify the default ID prefix with the reverse DNS name of your
 * institute by setting the ID_PREFIX param:
 *
 *   xalan -param ID_PREFIX "'smi:org.gfz.de/geofon/'" -in scml.xml -xsl scml_0.14__quakeml_1.2-RT.xsl -out quakeml.xml
 *   xsltproc -stringparam ID_PREFIX smi:org.gfz.de/geofon/ -o quakeml.xml scml_0.14__quakeml_1.2-RT.xsl scml.xml
 *
 * ================
 * Transformation
 * ================
 ...
 *  - Repositioning of 'magnitude' and 'stationMagnitude' nodes : Whereas SCML
 ...
 *    the magnitude nodes (except an originID was specified in the SCML
 *    sources nodes).
 *
 *    <EventParameters>               <eventParameters>
 *      <origin publicID="foo">         <origin publicID="smi:org.gfz.de/geofon/foo"/>
 *        <stationMagnitude/>           <stationMagnitude>
 *                                          <originID>smi:org.gfz.de/geofon/foo</originID>
 *                                      </stationMagnitude>
 *        <magnitude>                   <magnitude>
 *          <originID>bar</originID>      <originID>smi:org.gfz.de/geofon/bar</originID>
 *        </magnitude>                  </magnitude>
 *    </EventParameters>              </eventParameters>
 *
 *  - An 'event' in SCML and QuakeML-RT refers to its origins via
 *    'originReference' elements. Since in SCML 'magnitude' elements are
 ...
 *
 *  * 01.11.2023:
 *    - Map additional SeisComP event types 'calving', 'frost quake',
 *      'tremor pulse', 'submarine landslide', 'rocket impact',
 *      'artillery strike', 'bomb detonation', 'moving aircraft',
 *      'atmospheric meteor explosion', 'volcano-tectonic',
 *      'volcanic long-period', 'volcanic very-long-period', 'volcanic hybrid',
 *      'volcanic rockfall', 'volcanic tremor', 'pyroclastic flow' and 'lahar'
 ...
 *    - Do not export Catalog elements as they are not supported by QuakeML
 *
 ********************************************************************** -->
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="scs:catalog"/>
