 ...
 *
 *=========================================================================*/
#ifndef __LEASTSQUARES_LSQR_H__
#define __LEASTSQUARES_LSQR_H__
...
public:
   ...
   */
  virtual void Aprod1(unsigned int m, unsigned int n, const double *x,
                      double *y) const = 0;
   ...
   * The size of the vector y is m.
   */
  virtual void Aprod2(unsigned int m, unsigned int n, double *x,
